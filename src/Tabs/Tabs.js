...
class Tabs extends Component {
  constructor(props) {
	 ...
	 * @param { number } tabIndex the tab index passed from the onClick function.
	 */
	 ...
	 * @param { number } tabIndex style object to check.
	 * @returns { number } the next tab index determined by the current index in state
	 */
	...
	/**
	 * Function that renders Tabs and its children whilst passing props to each instance of Tab
	 */
	renderTabs() {
	  const { currentTabIndex } = this.state;
	...
	/**
	 * Function that renders the children of Tab instances
	 */
